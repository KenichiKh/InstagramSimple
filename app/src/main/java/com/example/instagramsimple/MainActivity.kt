...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.postbutton).setOnClickListener{
            // Send post to server without the image
            ...
            if (photoFile != null){
                ...
                Log.i(TAG, "Error, No Image Found")
    ...
    fun submitPost(description: String, user: ParseUser, file: File){
        ...
        post.saveInBackground{ exception ->
            if(exception != null){
                ...
                Toast.makeText(this,"Post save Error", Toast.LENGTH_SHORT).show()
            } else{
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                val ivPreview: ImageView = findViewById(R.id.ivFileView)
